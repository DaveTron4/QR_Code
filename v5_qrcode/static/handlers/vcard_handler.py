...
def vcard_handler(name, phone, email, qr_shape, qr_style, image_path = None):
    ...
    qr_code_path = generate_vcard_qr(name, phone, email, qr_shape, qr_style, image_path)  # Pass the image path to the function if available
