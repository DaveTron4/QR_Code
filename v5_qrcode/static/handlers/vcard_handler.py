...
def vcard_handler(name, phone, email, qr_shape, qr_style, image_path = None, solid_color=None, start_color=None, end_color=None, mask_image_path=None):
    ...
    qr_code_path = generate_vcard_qr(name, phone, email, qr_shape, qr_style, image_path, solid_color, start_color, end_color, mask_image_path)  # Pass the image path to the function if available
